...
<div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url({{ asset('assets/frontend/img/blog-img/slider/1.jpg')}});"></div>
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay" style="background-image: url({{ asset('assets/frontend/img/blog-img/slider/2.jpg')}});"></div>
        </div>
